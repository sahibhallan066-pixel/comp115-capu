...
print(f"""
Exercise 2:
{dividend} ÷ {divisor} = quotient is {quotient} 
{dividend} ÷ {divisor} = remainder is {remainder}
""")
...
day_start=int(input("What day does trip start"))
days_trip=int(input("What is the duration of your trip"))
final_output= (days_trip-day_start) % 7 


print(f""" Your trip starts on day {day_start}, lasts {days_trip} days. You are back on day {final_output}""")
